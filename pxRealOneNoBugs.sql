...
--
-- Host: 127.0.0.1
-- Generation Time: May 26, 2017 at 02:27 AM
...
(1, 1, 1, '2017-04-12 00:00:00', '07:00:00', '16:00:00', 1, 8, 'Hard Days Work'),
...
--
ALTER TABLE `job`
  MODIFY `JobID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `timesheet`
--
ALTER TABLE `timesheet`
  MODIFY `TimesheetID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `timesheetdetail`
--
ALTER TABLE `timesheetdetail`
  MODIFY `TsDetailID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `userjob`
  MODIFY `UserJobID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
